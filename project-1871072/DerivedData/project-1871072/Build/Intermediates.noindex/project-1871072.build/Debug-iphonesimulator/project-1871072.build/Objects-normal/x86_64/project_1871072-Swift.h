...
#ifndef PROJECT_1871072_SWIFT_H
#define PROJECT_1871072_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="project_1871072",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15project_187107211AppDelegate")
...
SWIFT_CLASS("_TtC15project_18710724Item")
...
SWIFT_CLASS("_TtC15project_187107224ItemDetailViewController")
...
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified accountTextField;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified phoneNumTextField;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified countTextField;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end


@interface ItemDetailViewController (SWIFT_EXTENSION(project_1871072))
...
@interface ItemDetailViewController (SWIFT_EXTENSION(project_1871072))
- (void)dismissKeyBoardWithSender:(UITapGestureRecognizer * _Nonnull)sender;
@end
...
SWIFT_CLASS("_TtC15project_18710729ItemGroup")
...
SWIFT_CLASS("_TtC15project_187107223ItemGroupViewController")
@interface ItemGroupViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified itemTableView;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface ItemGroupViewController (SWIFT_EXTENSION(project_1871072))
...
@interface ItemGroupViewController (SWIFT_EXTENSION(project_1871072))
- (IBAction)editTable1:(UIBarButtonItem * _Nonnull)sender;
@end
...
@interface ItemGroupViewController (SWIFT_EXTENSION(project_1871072))
- (IBAction)addItem1:(UIBarButtonItem * _Nonnull)sender;
@end

@class UITableViewCell;

@interface ItemGroupViewController (SWIFT_EXTENSION(project_1871072)) <UITableViewDataSource>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end


@interface ItemGroupViewController (SWIFT_EXTENSION(project_1871072)) <UITableViewDelegate>
...
SWIFT_CLASS("_TtC15project_187107213SceneDelegate")
